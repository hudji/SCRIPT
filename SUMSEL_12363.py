...
for item in IC_final:
    ...
    dst_ds = driver.Create("D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP030118/" +item + "forest999.tif", shape[1], shape[0], 1, gdal.GDT_Float64)
...
export_array(IC, "D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP110118/ICsumsel.TIF")
