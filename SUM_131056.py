...
import numexpr
#Load Metadata
path_f = 'D:/FORESTS2020/DATA/LANDSAT/OLAH/PATH ROW/131056/*.txt'#open file for reading
...
#Load data raster
path='D:/FORESTS2020/DATA/LANDSAT/OLAH/PATH ROW/131056/'
...
pathname='D:/FORESTS2020/DATA/LANDSAT/OLAH/DEM/'
...
pathsample='D:/FORESTS2020/DATA/LANDSAT/OLAH/SAMPLE/'
...
for item in IC_final:
    ...
    dst_ds = driver.Create("D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP160118/" +item + "_I.TIF", shape[1], shape[0], 1, gdal.GDT_Float64)
...
export_array(IC, "D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP160118/IC.TIF")
