...
pathname='D:/FORESTS2020/DATA/LANDSAT/ANALISIS/DEM/'
...
pathsample='D:/FORESTS2020/DATA/LANDSAT/ANALISIS/SAMPLE/'
...
# AOI= read[5]>=0
# aspect= numexpr.evaluate("(dem_dict['slope']) / (AOI == True)")
# IC calculation
...
AOI = read [5] > 0
hutan= sample == 1
sample_ndvi= numexpr.evaluate("(NDVI >0.5) & (hutan==True) & (AOI == True)")
...
for item in IC_final:
    ...
    dst_ds = driver.Create("D:/FORESTS2020/TRAINING/Python/RESULT/TOPO/TP310118/126061/" +item + "topo3.TIF", shape[1], shape[0], 1, gdal.GDT_Float32)
...
export_array(sample_ndvi, "D:/FORESTS2020/TRAINING/Python/RESULT/TOPO/TP310118/126061/sample3.TIF")
