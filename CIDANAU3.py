...
import numexpr
#Load Metadata
path_f = 'D:/FORESTS2020/TRAINING/PyQgis/DATA/Landsat8/CIDANAU/GEO/CIDANAU/AOI/BARU/LANDSAT/*.txt'#open file for reading
...
#Load data raster
path='D:/FORESTS2020/TRAINING/PyQgis/DATA/Landsat8/CIDANAU/GEO/CIDANAU/AOI/BARU/LANDSAT/'
...
pathname='D:/FORESTS2020/TRAINING/PyQgis/DATA/Landsat8/CIDANAU/GEO/CIDANAU/AOI/BARU/DEM/*.tif'
...
slope2= dem_dict['slope2'] > 45
sample_ndvi= numexpr.evaluate("(NDVI >0.5) & (slope2==True)")
...
for item in IC_final:
    ...
    dst_ds = driver.Create("D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP271217/AOI/" +item + "new.tif", shape[1], shape[0], 1, gdal.GDT_Float32)
...
export_array(sample_ndvi, "D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP271217/CIDANU/samplendvi.TIF")
...
for c in IC_final:
        ...
        dfn.to_csv("D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP271217/AOI/sample.csv", index= False)