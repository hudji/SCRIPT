...
for item in IC_final:
    ...
    dst_ds = driver.Create("D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP281217/" +item + "forest.tif", shape[1], shape[0], 1, gdal.GDT_Float32)
...
export_array(sample_ndvi, "D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP281217/sample_forest.TIF")
...
for c in IC_final:
        ...
        dfn.to_csv("D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP281217/sampleforest.csv", index= False)