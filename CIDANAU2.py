...
import numexpr
#Load Metadata
path_f = 'D:/FORESTS2020/TRAINING/PyQgis/DATA/Landsat8/CIDANAU/GEO/CIDANAU/DATA/*.txt'#open file for reading
...
#Load data raster
path='D:/FORESTS2020/TRAINING/PyQgis/DATA/Landsat8/CIDANAU/GEO/CIDANAU/DATA/'
...
pathname='D:/FORESTS2020/TRAINING/PyQgis/DATA/Landsat8/CIDANAU/GEO/CIDANAU/DEM/*.tif'
...
for item in IC_final:
    ...
    dst_ds = driver.Create("D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP271217/CIDANAU/" +item + "new.tif", shape[1], shape[0], 1, gdal.GDT_Float32)
...
for c in IC_final:
        ...
        dfn.to_csv("D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP271217/CIDANAU/sample.csv", index= False)