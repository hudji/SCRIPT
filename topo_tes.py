...
for item in IC_final:
    ...
    dst_ds = driver.Create("D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP111217/"+item+"_III.tif", shape[1], shape[0], 1, gdal.GDT_Float32)
...
shape = my_dict['band2'].shape
driver = gdal.GetDriverByName("GTiff")
dst_ds = driver.Create("D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP111217/Band6_II.tif", shape[1], shape[0], 1, gdal.GDT_Float32)
dst_ds.SetGeoTransform(geo)
dst_ds.SetProjection(proj)
dst_ds.GetRasterBand(1).WriteArray(IC_final['band6'])
dst_ds = None  # save, close"""
