...
f = open('D:/FORESTS2020/TRAINING/PyQgis/DATA/Landsat8/NO SEA/FINAL/GEO/LANDSAT/mtl.txt', 'r') #open file for reading
def build_data(f):
    output = {}
...
raster_list=glob.glob('D:/FORESTS2020/TRAINING/PyQgis/DATA/Landsat8/NO SEA/FINAL/GEO/LANDSAT/*.TIF')
read=[]
for i in raster_list:
    band=gdal.Open(i)
    read.append(band.GetRasterBand(1).ReadAsArray())
data_name=['band1', 'band10', 'band11', 'band2', 'band3', 'band4', 'band5','band6', 'band7', 'band8', 'band9', 'bandBQA']
...
for item in IC_final:
    ...
    dst_ds = driver.Create("D:/FORESTS2020/TRAINING/PyQgis/DATA/Landsat8/NO SEA/FINAL/GEO/RESULT/"+item+".tif", shape[1], shape[0], 1, gdal.GDT_Float32)
