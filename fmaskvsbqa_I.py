...
#Load data raster
path='D:/FORESTS2020/TRAINING/PyQgis/DATA/Landsat8/NO SEA/FINAL/GEO/LANDSAT/TRIAL/*.TIF'
raster_list=glob.glob(path)
read=[]
...
filename=[]
for a in [os.path.basename(x) for x in glob.glob(path)]:
    p=os.path.splitext(a)[0]
    filename.append(p)
my_dict= dict(zip(filename, read))

#Load data raster aspect, slope & sample area
pathname='D:/FORESTS2020/TRAINING/PyQgis/DATA/Landsat8/NO SEA/FINAL/GEO/DEM/*.tif'
...
#bqa
prob_cloud= my_dict['LC81220652016230LGN00_BQA'] >= 53248 # https://landsat.usgs.gov/qualityband
...
export_array(cleaning, "D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/Cloud_Masking/C121217/cleaning_II.tif")
#Buffering
...
export_array(basic_test, "D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/Cloud_Masking/C121217/Basic_I.tif")
export_array(prob_cloud, "D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/Cloud_Masking/C121217/Basic_prob_I.tif")
export_array(prob_cloud2, "D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/Cloud_Masking/C121217/Basic_prob2_I.tif")
export_array(filtering, "D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/Cloud_Masking/C121217/filtering_I.tif")
export_array(filtering, "D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/Cloud_Masking/C121217/filtering_I.tif")
export_array(filtering2, "D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/Cloud_Masking/C131217/filtering2.tif")
#export_array(cleaning_open, "D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/Cloud_Masking/C121217/cleaning_open_I.tif")


#call(gdalwarp, '-dstnodata -9999 -cutline', shp, in_raster, out_raster )
#subprocess.call('echo $gdalwarp -dstnodata -9999 -cutline D:/FORESTS2020/TRAINING/PyQgis/DATA/source/TEST/no_sea.shp D:/FORESTS2020/TRAINING/PyQgis/DATA/source/GEO/LC81220652016230LGN00_B1.TIF D:/FORESTS2020/TRAINING/PyQgis/DATA/source/TEST/LC81220652016230LGN00_B1_fix2.TIF', shell=True)
