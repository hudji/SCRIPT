...
import numexpr
#Load Metadata
path_f = 'D:/FORESTS2020/DATA/LANDSAT/PATH ROW/127061/*.txt'#open file for reading
...
#Load data raster
path='D:/FORESTS2020/DATA/LANDSAT/PATH ROW/127061/'
...
for item in IC_final:
    ...
    dst_ds = driver.Create("D:/FORESTS2020/TRAINING/Python/RESULT/TOPO/TP220118/127061/" +item + ".tif", shape[1], shape[0], 1, gdal.GDT_Float64)
