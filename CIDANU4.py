...
pathname='D:/FORESTS2020/TRAINING/PyQgis/DATA/Landsat8/CIDANAU/GEO/DEM/*.tif'
...
hutan= dem_dict['baplan'] == 1
sample_ndvi= numexpr.evaluate("(NDVI >0.5) & (slope2==True) & (hutan==True)")
...
for item in IC_final:
    ...
    dst_ds = driver.Create("D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP281217/" +item + ".tif", shape[1], shape[0], 1, gdal.GDT_Float32)
...
export_array(IC, "D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP281217/IC.TIF")
...
for c in IC_final:
        ...
        dfn.to_csv("D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP281217/sample.csv", index= False)