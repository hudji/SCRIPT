...
f = open('D:/FORESTS2020/TRAINING/Python/DATA/Landsat8/SUMSEL/123_63/LC08_L1TP_123063_20160621_20170323_01_T1/LC08_L1TP_123063_20160621_20170323_01_T1_MTL.txt') #open file for reading
...
#Load data raster
path='D:/FORESTS2020/TRAINING/Python/DATA/Landsat8/SUMSEL/123_63/LC08_L1TP_123063_20160621_20170323_01_T1/'
...
pathname='D:/FORESTS2020/TRAINING/Python/DATA/Landsat8/SUMSEL/123_63/DEM/*.TIF'
...
def year_date():
    ...
    parsing = datetime.datetime.strptime(all, '%Y-%m-%d %H:%M:%S.%f')
    return parsing
dt=year_date()
...
#Reflectance
reflectance_blue=(float(data['REFLECTANCE_MULT_BAND_2'])*my_dict[filename[0][0:41]+'B2']+float(data['REFLECTANCE_ADD_BAND_2']))/cos(zenit_angle)
reflectance_red=(float(data['REFLECTANCE_MULT_BAND_4'])*my_dict[filename[0][0:41]+'B4']+float(data['REFLECTANCE_ADD_BAND_4']))/cos(zenit_angle)
reflectance_nir=(float(data['REFLECTANCE_MULT_BAND_5'])*my_dict[filename[0][0:41]+'B5']+float(data['REFLECTANCE_ADD_BAND_5']))/cos(zenit_angle)
reflectance_swir1=(float(data['REFLECTANCE_MULT_BAND_6'])*my_dict[filename[0][0:41]+'B6']+float(data['REFLECTANCE_ADD_BAND_6']))/cos(zenit_angle)
reflectance_swir2=(float(data['REFLECTANCE_MULT_BAND_7'])*my_dict[filename[0][0:41]+'B7']+float(data['REFLECTANCE_ADD_BAND_7']))/cos(zenit_angle)
reflectance_green=(float(data['REFLECTANCE_MULT_BAND_3'])*my_dict[filename[0][0:41]+'B3']+float(data['REFLECTANCE_ADD_BAND_3']))/cos(zenit_angle)

#Brightness Temperature
radiance_tirs1=(float(data['RADIANCE_MULT_BAND_10'])*my_dict[filename[0][0:41]+'B10']+float(data['RADIANCE_ADD_BAND_10']))
...
#bqa
bqa= my_dict[filename[0][0:41]+'BQA']
prob_cloud= numexpr.evaluate("(bqa >= 53248)")
                             "|(bqa == 56320)| (bqa == 61440)| (bqa== 64512) ") # https://landsat.usgs.gov/qualityband
...
export_array(raster_buffer_array, 'D:/FORESTS2020/TRAINING/Python/RESULT/AUTO/CLOUD/C181217/Cloud-'+filename_today+'.TIF')
export_array(prob_cloud, 'D:/FORESTS2020/TRAINING/Python/RESULT/AUTO/CLOUD/C181217/prob_I.TIF')
