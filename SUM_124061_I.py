...
pathname='D:/FORESTS2020/DATA/LANDSAT/DEM/124061/'
...
for item in IC_final:
    ...
    dst_ds = driver.Create("D:/FORESTS2020/TRAINING/Python/RESULT/TOPO/TP310118/124061_I/" +item + "topo2.TIF", shape[1], shape[0], 1, gdal.GDT_Float32)
