...
for item in IC_final:
    ...
    dst_ds = driver.Create("D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP201217/CLIP/" +item + ".tif", shape[1], shape[0], 1, gdal.GDT_Float32)
...
# def csv():
    ...
    for c in IC_final:
        ...
        dfn.to_csv("D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP211217/sample_REF.csv", index= False)
