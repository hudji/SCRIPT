...
# Potential cloud
Potential_cloud= numexpr.evaluate('(basic_test & (wCloud_Prob > 0.5) & (WT == 0)) | (basic_test & (wCloud_Prob > Land_threshold) & (WT == 1)) | (ICloud_Prob < t_templ - 3500)')
Potential_cloud= numexpr.evaluate('(basic_test==True) & (WT==True)&(wCloud_Prob > 0.5) | (basic_test==True) & (WT==False) & (ICloud_Prob > Land_threshold) | (ICloud_Prob >0.99) & (WT==False)|(BT<T_low -35)')


export_array(Potential_cloud, "D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/Cloud Masking/C061217/PCL_I.tif")
