...
pathname='D:/FORESTS2020/TRAINING/PyQgis/DATA/Landsat8/NO_SEA/FINAL/GEO/DEM2/'
raster_list_dem=glob.glob(pathname + filename[0][3:9]+"*.tif" )
folder=filename[0][3:9]
raster_list_dem=glob.glob(pathname+'F'+folder+'/*.tif')
filename_dem=[]
...
for item in IC_final:
    ...
    dst_ds = driver.Create("D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP131217/"+item+"_X2.TIF", shape[1], shape[0], 1, gdal.GDT_Float32)
