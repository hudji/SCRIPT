...
#Load Metadata
f = open('D:\mtl.txt', 'r') #open file for reading
def build_data(f):
    output = {}
...
dst_ds = driver.Create("D:\FORESTS2020\TRAINING\PyQgis\DATA\SCRIPT\Auto\Result\R151117\Band6.tif", shape[1], shape[0], 1, gdal.GDT_Float32)
