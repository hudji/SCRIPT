...
# sample
area_true= masking_NDVI_3.nonzero() #outputnya index row n col
a_true=area_true[0]
b_true=area_true[1]
#correction
...
for c in IC_final:
        ...
        dfn.to_csv("D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP201217/sample.csv", index= False)
