...
import numexpr
#Load Metadata
f = open('D:/FORESTS2020/TRAINING/PyQgis/DATA/Landsat8/NO_SEA/FINAL/GEO/LANDSAT/mtl.txt', 'r') #open file for reading
def build_data(f):
    output = {}
...
slope35 = dem_dict['slope2'] > 35
sample_ndvi= numexpr.evaluate("(NDVI >0.5)")
masking_NDVI= numexpr.evaluate("(sample_ndvi== True) & (cloudArray == 0) & (slope35 == True)")
...
for item in IC_final:
    ...
    dst_ds = driver.Create("D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP211217/" +item + "samp.tif", shape[1], shape[0], 1, gdal.GDT_Float32)
...
for c in IC_final:
        ...
        dfn.to_csv("D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP221217/sample_REF_SAMPL.csv", index= False)
...
export_array(IC, "D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP211217/IC2.TIF")
