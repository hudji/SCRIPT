...
import numexpr
#Load Metadata
path_f = 'D:/FORESTS2020/TRAINING/PyQgis/DATA/Landsat8/CIDANAU/GEO/LANDSAT/*.txt'#open file for reading
...
#Load data raster
path='D:/FORESTS2020/TRAINING/PyQgis/DATA/Landsat8/CIDANAU/GEO/LANDSAT/'
...
pathname='D:/FORESTS2020/TRAINING/PyQgis/DATA/Landsat8/CIDANAU/GEO/TOPO/*.tif'
...
for item in IC_final:
    ...
    dst_ds = driver.Create("D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP271217/" +item + "45.tif", shape[1], shape[0], 1, gdal.GDT_Float32)
...
export_array(sample_ndvi, "D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP271217/NEW/samplendvi.TIF")
...
for c in IC_final:
        ...
        dfn.to_csv("D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP271217/NEW/sample_mask45.csv", index= False)