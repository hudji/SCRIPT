...
f = open('D:/FORESTS2020/TRAINING/Python/DATA/Landsat8/LAPAN/GEO/LC81200652016120LGN00/LC81200652016120LGN00_MTL.txt') #open file for reading
...
#Load data raster
path='D:/FORESTS2020/TRAINING/Python/DATA/Landsat8/LAPAN/GEO/LC81200652016120LGN00/'
...
pathname='D:/FORESTS2020/TRAINING/Python/DATA/Landsat8/LAPAN/GEO/DEM/*.TIF'
...
#Reflectance
reflectance_blue=(float(data['REFLECTANCE_MULT_BAND_2'])*my_dict[filename[0][0:22]+'B2']+float(data['REFLECTANCE_ADD_BAND_2']))/cos(zenit_angle)
reflectance_red=(float(data['REFLECTANCE_MULT_BAND_4'])*my_dict[filename[0][0:22]+'B4']+float(data['REFLECTANCE_ADD_BAND_4']))/cos(zenit_angle)
reflectance_nir=(float(data['REFLECTANCE_MULT_BAND_5'])*my_dict[filename[0][0:22]+'B5']+float(data['REFLECTANCE_ADD_BAND_5']))/cos(zenit_angle)
reflectance_swir1=(float(data['REFLECTANCE_MULT_BAND_6'])*my_dict[filename[0][0:22]+'B6']+float(data['REFLECTANCE_ADD_BAND_6']))/cos(zenit_angle)
reflectance_swir2=(float(data['REFLECTANCE_MULT_BAND_7'])*my_dict[filename[0][0:22]+'B7']+float(data['REFLECTANCE_ADD_BAND_7']))/cos(zenit_angle)
reflectance_green=(float(data['REFLECTANCE_MULT_BAND_3'])*my_dict[filename[0][0:22]+'B3']+float(data['REFLECTANCE_ADD_BAND_3']))/cos(zenit_angle)

#Brightness Temperature
radiance_tirs1=(float(data['RADIANCE_MULT_BAND_10'])*my_dict[filename[0][0:22]+'B10']+float(data['RADIANCE_ADD_BAND_10']))
...
#bqa
bqa= my_dict[filename[0][0:22]+'BQA']
...
export_array(raster_buffer_array, 'D:/FORESTS2020/TRAINING/Python/RESULT/AUTO/CLOUD/C181217/CloudLAPAN2-'+filename_today+'.TIF')
