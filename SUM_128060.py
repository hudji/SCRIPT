...
import numexpr
#Load Metadata
path_f = 'D:/FORESTS2020/DATA/LANDSAT/PATH ROW/128060/*.txt'#open file for reading
...
#Load data raster
path='D:/FORESTS2020/DATA/LANDSAT/PATH ROW/128060/'
...
hutan= sample == 1
sample_ndvi= numexpr.evaluate("(NDVI >0.8) & (hutan==True)")
...
for item in IC_final:
    ...
    dst_ds = driver.Create("D:/FORESTS2020/TRAINING/Python/RESULT/TOPO/TP220118/128060/" +item + ".tif", shape[1], shape[0], 1, gdal.GDT_Float64)
...
export_array(sample_ndvi, "D:/FORESTS2020/TRAINING/Python/RESULT/TOPO/TP220118/128060/sample.TIF")
