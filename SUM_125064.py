...
import numexpr
#Load Metadata
path_f = 'D:/FORESTS2020/DATA/LANDSAT/PATH ROW/125064/*.txt'#open file for reading
...
#Load data raster
path='D:/FORESTS2020/DATA/LANDSAT/PATH ROW/125064/'
...
for item in IC_final:
    ...
    dst_ds = driver.Create("D:/FORESTS2020/TRAINING/Python/RESULT/TOPO/TP240118/125064/" +item + "topo.TIF", shape[1], shape[0], 1, gdal.GDT_Float32)
...
for c in IC_final:
        ...
        dfn.to_csv("D:/FORESTS2020/TRAINING/Python/RESULT/TOPO/TP190118/125063/sample12563.csv", index= False)