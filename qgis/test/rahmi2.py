...
#Load data raster
raster_list2=glob.glob('D:\PROJECT\RAHMI\Data\Coba\*.TIF')
read=[]
...
dst_ds = driver.Create("D:\PROJECT\RAHMI\Result\R161017\C2\IC_5M1.tif", shape[1], shape[0], 1, gdal.GDT_Float32)
...
df.to_csv('D:\PROJECT\RAHMI\Result\R161017\C2\samplePoint2.csv', index=False)