...
dst_ds = driver.Create("D:\PROJECT\FOREST 2020\TRAINING\PyQgis\RESULT\Landsat8\L011117\Band2R.tif", shape[1], shape[0], 1, gdal.GDT_Float32)
...
df.to_csv('D:\PROJECT\FOREST 2020\TRAINING\PyQgis\RESULT\Landsat8\L191017\sampleR.csv', index=False)
