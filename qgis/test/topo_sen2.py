...
dst_ds = driver.Create("D:\PROJECT\FOREST 2020\TRAINING\PyQgis\RESULT\Sentinel2\S51017\IC_11.tif", shape[1], shape[0], 1, gdal.GDT_Float32)
...
df.to_csv('D:\PROJECT\FOREST 2020\TRAINING\PyQgis\RESULT\Sentinel2\S51017\sample.csv', index=False)