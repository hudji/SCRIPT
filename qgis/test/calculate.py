...
gamma=((2 * math.pi) / leap()) * ((day() - 1) + ((hour() - 12) / 24) )# degree
...
dst_ds = driver.Create("D:\PROJECT\FOREST 2020\TRAINING\PyQgis\RESULT\Landsat8\L111017\Band2_IC.tif", shape[1], shape[0], 1, gdal.GDT_Float32)
...
df.to_csv('D:\PROJECT\FOREST 2020\TRAINING\PyQgis\RESULT\Landsat8\L111017\sample2.csv', index=False)
