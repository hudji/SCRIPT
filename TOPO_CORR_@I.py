...
data_name=['band2', 'band3', 'band4', 'band5', 'band6']
...
for item in IC_final:
    ...
    dst_ds = driver.Create("D:/FORESTS2020/TRAINING/PyQgis/DATA/Landsat8/NO SEA/FINAL/GEO/RESULT/"+item+"_X.tif", shape[1], shape[0], 1, gdal.GDT_Float32)
...
def csv():
    ...
    for c in IC_final:
        ...
        dfn.to_csv("D:/FORESTS2020/TRAINING/PyQgis/DATA/Landsat8/NO SEA/FINAL/GEO/RESULT/sample.csv", index= False)
