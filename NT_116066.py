...
import numexpr
#Load Metadata
path_f = 'D:/FORESTS2020/DATA/LANDSAT/PATH ROW/116066/*.txt'#open file for reading
...
#Load data raster
path='D:/FORESTS2020/DATA/LANDSAT/PATH ROW/116066/'
...
for item in IC_final:
    ...
    dst_ds = driver.Create("D:/FORESTS2020/TRAINING/Python/RESULT/TOPO/TP310118/116066/" +item + "topo.TIF", shape[1], shape[0], 1, gdal.GDT_Float32)
...
export_array(IC, "D:/FORESTS2020/TRAINING/Python/RESULT/TOPO/TP310118/IC.TIF")
