...
import numexpr
#Load Metadata
path_f = 'D:/FORESTS2020/TRAINING/PyQgis/DATA/Landsat8/SUMSEL/GEO/FINAL/PATH ROW/125062/*.txt'#open file for reading
...
#Load data raster
path='D:/FORESTS2020/TRAINING/PyQgis/DATA/Landsat8/SUMSEL/GEO/FINAL/PATH ROW/125062/'
...
for item in IC_final:
    ...
    dst_ds = driver.Create("D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP050118/125062/" +item + ".TIF", shape[1], shape[0], 1, gdal.GDT_Float64)
