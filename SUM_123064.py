...
import numexpr
#Load Metadata
path_f = 'D:/FORESTS2020/DATA/LANDSAT/PATH ROW/123064/*.txt'#open file for reading
...
#Load data raster
path='D:/FORESTS2020/DATA/LANDSAT/PATH ROW/123064/'
...
for item in IC_final:
    ...
    dst_ds = driver.Create("D:/FORESTS2020/TRAINING/Python/RESULT/TOPO/TP230118/123064/" +item + "topo_I.tif", shape[1], shape[0], 1, gdal.GDT_Float64)
...
export_array(sample_ndvi, "D:/FORESTS2020/TRAINING/Python/RESULT/TOPO/TP230118/123064//sample.TIF")
...
for c in IC_final:
        ...
        dfn.to_csv("D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP230118/123064/sample12363.csv", index= False)