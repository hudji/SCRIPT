...
import numexpr
#Load Metadata
path_f = 'D:/FORESTS2020/DATA/LANDSAT/PATH ROW/124062/*.txt'#open file for reading
...
#Load data raster
path='D:/FORESTS2020/DATA/LANDSAT/PATH ROW/124062/'
...
for item in IC_final:
    ...
    dst_ds = driver.Create("D:/FORESTS2020/TRAINING/Python/RESULT/TOPO/WINDOW AREA/SUMSEL/124062/" +item + "topo.TIF", shape[1], shape[0], 1, gdal.GDT_Float64)
...
export_array(sample_ndvi, "D:/FORESTS2020/TRAINING/Python/RESULT/TOPO/WINDOW AREA/SUMSEL/124062/sample_new.TIF")
export_array(IC, "D:/FORESTS2020/TRAINING/Python/RESULT/TOPO/WINDOW AREA/SUMSEL/124062/IC.TIF")
...
for c in IC_final:
        ...
        dfn.to_csv("D:/FORESTS2020/TRAINING/Python/RESULT/TOPO/WINDOW AREA/SUMSEL/125062/sample12562.csv", index= False)