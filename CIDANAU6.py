...
import numexpr
#Load Metadata
path_f = 'D:/FORESTS2020/TRAINING/PyQgis/DATA/Landsat8/CIDANAU/GEO/FINAL/LANDSAT/*.txt'#open file for reading
...
#Load data raster
path='D:/FORESTS2020/TRAINING/PyQgis/DATA/Landsat8/CIDANAU/GEO/FINAL/LANDSAT/'
...
pathsample='D:/FORESTS2020/TRAINING/PyQgis/DATA/Landsat8/CIDANAU/GEO/FINAL/SAMPLE/'
...
for item in IC_final:
    ...
    dst_ds = driver.Create("D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP120118/" +item + "_I.TIF", shape[1], shape[0], 1, gdal.GDT_Float64)
...
export_array(IC, "D:/FORESTS2020/TRAINING/PyQgis/RESULT/Landsat8/TOPO/TP110118/IC.TIF")
